          ...
          <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
              ...
              <a
                href="#"
                title=""
                class="inline-flex items-center justify-center px-5 py-2.5 text-base font-semibold transition-all duration-200 rounded-full bg-orange-500 text-white hover:bg-orange-600 focus:bg-orange-600"
                role="button"
              >
                {" "}
                Try for free{" "}
                  ...
                  <div class="flex flex-col items-start sm:flex-row">
                    ...
                    <Link to={"/templates"}>
                      <button
                        ...
                        class="inline-flex cursor-pointer items-center justify-center w-full px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-orange-500 border border-transparent rounded-full sm:w-auto sm:ml-4 sm:mt-0 hover:bg-orange-600 focus:bg-orange-600"
                      >
                        Try For free
                      </button>
                    </Link>
